...
mocha.describe('Atom - Manual escalation for pickup warehouse (release to pick tab)', function()
{
    this.timeout(60000);
    mocha.it('works', function() {
        ...
        console.log('');
        console.log('Running Manual escalation for pickup warehouse (release to pick tab)');
        console.log('');

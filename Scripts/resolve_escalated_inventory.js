...
mocha.describe('Atom - Resolve Inventory', function()
{
    this.timeout(60000);
    mocha.it('works', function() {
        ...
        console.log('');
        console.log('Running resolve_escalated_inventory');
        console.log('');
        ...
        driver.wait(function() {
            return driver.getCurrentUrl().then (function(link){
                ...
                if (link==='http://dev.atom.igbimo.com/home/index')
                {
                    ...
                    driver.findElement(webdriver.By.id("menu-inventorymanager")).click();
                    ...
                    driver.wait(function(){
                        ...
                        else
                        {
                            ...
                            //Wait for 15secs after clicking ok button so page reloads successfully
                            driver.sleep(15000);

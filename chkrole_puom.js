...
driver.findElement(webdriver.By.id("UserLogin_username")).sendKeys("cyclops");
...
//Retrieve DCOM Menu
driver.call(function() {
    driver.findElement(webdriver.By.id("menu-cordermanager")).getAttribute("innerText").then(function(menu1) {
        Atom.menu.m1 = menu1;
